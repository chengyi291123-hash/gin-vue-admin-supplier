...
import (
	...
	"github.com/flipped-aurora/gin-vue-admin/server/router/supplier"
...
func Routers() *gin.Engine {
	...
	supplierRouter := supplier.SupplierRouter{} // Manually added
	...
	}
	{
		...
		supplierRouter.InitSupplierRouter(PublicGroup) // 注册供应商路由 (无需鉴权，演示用)
	}
